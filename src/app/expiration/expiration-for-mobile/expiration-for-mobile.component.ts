...
@Component({
  selector: 'expiration-for-mobile',
  templateUrl: './expiration-for-mobile.component.html',
  styleUrls: ['./expiration-for-mobile.scss']
})

export class ExpirationForMobileComponent implements OnInit, OnDestroy {
