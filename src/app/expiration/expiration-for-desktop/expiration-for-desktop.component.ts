...
@Component({
  selector: 'expiration-for-desktop',
  templateUrl: './expiration-for-desktop.component.html',
  styleUrls: ['./expiration-for-desktop.scss']
})

export class ExpirationForDesktopComponent implements OnInit, OnDestroy {
  ...
  getAllExpirations() {
    ...
    .subscribe((expirations: Expiration[]) => {
      ...
      if (this.content) {
        ...
        this.dataSource.data = this.dataSource.data.sort((n1, n2) => n2.numRefExpiration - n1.numRefExpiration);
      }

      else {this.dataSource.data = expirations.sort((n1, n2) => n2.numRefExpiration - n1.numRefExpiration);}
