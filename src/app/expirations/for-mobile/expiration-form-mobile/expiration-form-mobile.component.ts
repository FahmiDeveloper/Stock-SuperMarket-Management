...
@Component({
  selector: 'expiration-form-mobile',
  templateUrl: './expiration-form-mobile.component.html',
  styleUrls: ['./expiration-form-mobile.scss']
})

export class ExpirationFormMobileComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ExpirationFormMobileComponent>,
