...
@Component({
  selector: 'clocking-form-for-mobile',
  templateUrl: './clocking-form-for-mobile.component.html',
  styleUrls: ['./clocking-form-for-mobile.scss']
})

export class ClockingFormForMobileComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ClockingFormForMobileComponent>,
