...
@Component({
  selector: 'medication-form-for-mobile',
  templateUrl: './medication-form-for-mobile.component.html',
  styleUrls: ['./medication-form-for-mobile.scss']
})

export class MedicationFormForMobileComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MedicationFormForMobileComponent>,
