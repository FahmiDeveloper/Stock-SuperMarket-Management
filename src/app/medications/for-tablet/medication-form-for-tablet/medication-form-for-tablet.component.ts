...
@Component({
  selector: 'medication-form-for-tablet',
  templateUrl: './medication-form-for-tablet.component.html',
  styleUrls: ['./medication-form-for-tablet.scss']
})

export class MedicationFormForTabletComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MedicationFormForTabletComponent>
  ) {}
