...
@Component({
  selector: 'anime-form-desktop',
  templateUrl: './anime-form-desktop.component.html',
  styleUrls: ['./anime-form-desktop.scss']
})

export class AnimeFormDesktopComponent implements OnInit {
