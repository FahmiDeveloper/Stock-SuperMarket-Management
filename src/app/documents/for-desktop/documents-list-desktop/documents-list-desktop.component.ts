...
import { DocumentFormDesktopComponent } from './document-form-desktop/document-form-desktop.component';
...
@Component({
  selector: 'documents-list-desktop',
  templateUrl: './documents-list-desktop.component.html',
  styleUrls: ['./documents-list-desktop.scss']
})

export class DocumentsListForDesktopComponent implements OnInit, OnDestroy {
  ...
  newDocument() {
    const dialogRef = this.dialogService.open(DocumentFormDesktopComponent, {width: '500px', data: {document: {}}});
  ...
  editDocument(document?: Document) {
    const dialogRef = this.dialogService.open(DocumentFormDesktopComponent, {width: '500px'});
