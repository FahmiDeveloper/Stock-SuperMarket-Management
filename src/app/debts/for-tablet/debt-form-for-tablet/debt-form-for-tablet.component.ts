...
@Component({
  selector: 'debt-form-for-tablet',
  templateUrl: './debt-form-for-tablet.component.html',
  styleUrls: ['./debt-form-for-tablet.scss']
})

export class DebtFormForTabletComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DebtFormForTabletComponent>
  ) {}
