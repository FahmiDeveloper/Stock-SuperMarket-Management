...
import { DebtFormForDesktopComponent } from './debt-form-for-desktop/debt-form-for-desktop.component';
...
export class DebtsForDesktopComponent implements OnInit, OnDestroy {
  ...
  newDebt() {
    const dialogRef = this.dialogService.open(DebtFormForDesktopComponent, {width: '800px', data: {movie: {}}});
    dialogRef.componentInstance.defaultDebts = this.debtsListCopie; 
  }

  editDebt(debt?: Debt) {
    const dialogRef = this.dialogService.open(DebtFormForDesktopComponent, {width: '800px'});
