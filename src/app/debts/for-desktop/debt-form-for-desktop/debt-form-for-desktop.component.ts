...
@Component({
  selector: 'debt-form-for-desktop',
  templateUrl: './debt-form-for-desktop.component.html',
  styleUrls: ['./debt-form-for-desktop.scss']
})

export class DebtFormForDesktopComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DebtFormForDesktopComponent>
  ) {}
