...
@Component({
  selector: 'debt-form-mobile',
  templateUrl: './debt-form-mobile.component.html',
  styleUrls: ['./debt-form-mobile.scss']
})

export class DebtFormMobileComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DebtFormMobileComponent>,
