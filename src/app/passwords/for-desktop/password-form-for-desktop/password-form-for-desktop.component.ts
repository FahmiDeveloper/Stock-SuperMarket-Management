...
@Component({
  selector: 'password-form-for-desktop',
  templateUrl: './password-form-for-desktop.component.html',
  styleUrls: ['./password-form-for-desktop.scss']
})

export class PasswordFormForDesktopComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PasswordFormForDesktopComponent>
  ) {}
