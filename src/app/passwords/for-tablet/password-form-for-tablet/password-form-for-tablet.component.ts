...
@Component({
  selector: 'password-form-for-tablet',
  templateUrl: './password-form-for-tablet.component.html',
  styleUrls: ['./password-form-for-tablet.scss']
})

export class PasswordFormForTabletComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PasswordFormForTabletComponent>
  ) {}
