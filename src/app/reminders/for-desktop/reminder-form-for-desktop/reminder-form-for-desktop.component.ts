...
@Component({
  selector: 'reminder-form-for-desktop',
  templateUrl: './reminder-form-for-desktop.component.html',
  styleUrls: ['./reminder-form-for-desktop.scss']
})

export class ReminderFormForDesktopComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ReminderFormForDesktopComponent>
  ) {}
