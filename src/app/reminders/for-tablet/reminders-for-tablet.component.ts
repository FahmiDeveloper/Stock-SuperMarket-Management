...
import { ReminderFormForTabletComponent } from './reminder-form-for-tablet/reminder-form-for-tablet.component';
...
@Component({
  selector: 'reminders-for-tablet',
  templateUrl: './reminders-for-tablet.component.html',
  styleUrls: ['./reminders-for-tablet.scss']
})

export class RemindersForTabletComponent implements OnInit, OnDestroy {
  ...
  newReminder() {  
    ...
    this.dialogService.open(ReminderFormForTabletComponent, config);
  }

  editReminder(reminder?: Reminder) {
    let config: MatDialogConfig = {panelClass: "dialog-responsive"}
    const dialogRef = this.dialogService.open(ReminderFormForTabletComponent, config);
