...
@Component({
    selector: 'clockings-list-desktop',
    templateUrl: './list-clockings-desktop.component.html',
    styleUrls: ['./list-clockings-desktop.scss']
})

export class ListClockingsForDesktopComponent {
