...
@Component({
  selector: 'movies-for-tablet',
  templateUrl: './movies-for-tablet.component.html',
  styleUrls: ['./movies-for-tablet.scss']
})

export class MoviesForTabletComponent implements OnInit, OnDestroy {
  ...
  showDetailsMovie(movieSelected: Movie) {
    ...
    const dialogRef = this.dialogService.open(MovieDetailsWithPartsTabletComponent, {width: '1150px'});
  ...
  newMovie() {
    const dialogRef = this.dialogService.open(MovieFormTabletComponent, {width: '500px', data: {movie: {}}});
